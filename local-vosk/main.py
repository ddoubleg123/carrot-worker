...
print("🚀 Starting local Vosk transcription service...")
logger.info("🚀 Starting local Vosk transcription service...")
...
MODEL_PATH = os.environ.get('MODEL_PATH', 'models/vosk-model-small-en-us-0.15')
...
def health_check():
    ...
    try:
        response = {'status': 'healthy', 'model_loaded': model is not None, 'service': 'local-vosk'}
...
def root():
    """Root endpoint"""
    return jsonify({
        'service': 'Local Vosk Transcription Service',
        'status': 'running',
